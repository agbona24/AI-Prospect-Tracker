...
export const metadata: Metadata = {
  title: 'Runvax vs Apollo.io — Local Business Leads Without Enterprise Pricing',
  description:
    'Apollo.io is built for enterprise B2B sales. Runvax is built for web designers who want to find local SMBs with no website in Lagos, Accra, Nairobi, or anywhere worldwide.',
  alternates: { canonical: `${SITE_URL}/vs-apollo` },
  openGraph: {
    title: `Runvax vs Apollo.io — Right Tool for Web Designers`,
    description:
      'Apollo.io is enterprise B2B. Runvax finds local SMBs with no website and writes personalized outreach automatically. Free plan available.',
...
const comparisons = [
  {
    ...
    runvax: 'Local SMBs in any city — restaurants, salons, clinics, law firms',
  },
  {
    feature: 'Data source',
    apollo: 'Static database (may be outdated, limited Africa coverage)',
    runvax: 'Real-time Google business data — always current, every city worldwide',
  },
  {
    feature: 'No-website filter',
    apollo: 'Not available — built for companies that already have a web presence',
    runvax: 'Core feature — instantly shows which businesses have no website',
  },
  {
    feature: 'WhatsApp outreach',
    apollo: 'Not supported — email and phone call sequences only',
    runvax: 'Built-in AI WhatsApp message generator for African markets',
  },
  {
    feature: 'Nigeria / Africa data',
    apollo: 'Limited coverage, inaccurate for Nigerian SMBs',
    runvax: 'Full real-time coverage: Nigeria, Ghana, Kenya, South Africa, Uganda, and more',
  },
  {
    feature: 'AI outreach',
    apollo: 'Email sequences (template-based)',
    runvax: 'AI writes unique cold email, WhatsApp message, and proposal per prospect',
  },
  {
    feature: 'Pricing',
    apollo: '$49–$119/month USD minimum for useful features',
    runvax: '₦9,999/month (~$6 USD). Free plan available.',
  },
  {
    feature: 'Pipeline management',
    apollo: 'CRM integrations required (Salesforce, HubSpot)',
    runvax: 'Built-in Kanban pipeline — no integrations needed',
  },
];
...
const jsonLd = {
  ...
  '@type': 'WebPage',
  name: 'Runvax vs Apollo.io',
  description: 'Why web designers should use Runvax instead of Apollo.io for local SMB leads.',
  url: `${SITE_URL}/vs-apollo`,
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="mb-16 grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-indigo-950/40 border border-indigo-800/50 rounded-2xl p-6">
              <h3 className="font-bold text-lg mb-3 text-indigo-400">🏪 Runvax is for:</h3>
          ...
          <div className="mb-16 bg-gray-900 border border-gray-800 rounded-2xl p-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              LinkedIn. They are registered on Google Maps. That is where Runvax searches.
            </p>
            <p className="text-gray-300">
              Runvax gives you real-time access to every restaurant, salon, clinic, law firm, and
